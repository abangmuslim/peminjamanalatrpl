...
<section class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <!-- TABEL DATA kategori -->
       <div class="card-header bg-gradient-warning">
          <h6 class="card-title text-white"><i class="fas fa-plus-circle"></i> Daftar kategori</h6>
        </div>
      <table id="example1" class="table table-bordered table-striped text-sm">
        ...
        <tbody>
          ...
          $sql = mysqli_query($koneksi, "SELECT * FROM kategori ORDER BY idkategori DESC");
          while ($data = mysqli_fetch_array($sql)) {
            echo "
              <tr>
                ...
                <td>
                  <a href='index.php?halaman=editkategori&idkategori=$data[idkategori]' class='btn btn-sm btn-success' title='Edit'><i class='fa fa-pencil-alt'></i></a>
                  <a href='db/dbkategori.php?proses=hapus&idkategori=$data[idkategori]' class='btn btn-sm btn-danger' title='Hapus' onclick=\"return confirm('Yakin ingin menghapus data ini?')\"><i class='fa fa-trash'></i></a>
                </td>
              </tr>
            ";
            $no++;
    ...
    <div class="card-footer">
      <small>Data kategori - Aplikasi Peminjaman Alat RPL</small>
    </div>
    <!-- /.card-footer-->
  </div>
  <!-- /.card -->
